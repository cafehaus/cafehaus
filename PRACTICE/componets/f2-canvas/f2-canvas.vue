<template>
<uni-shadow-root class="f2-canvas-f2-canvas"><canvas class="f2-canvas" :canvas-id="canvasId" @init="init" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd" @longpress="press">
</canvas></uni-shadow-root>
</template>
...
global['__wxRoute'] = 'f2-canvas/f2-canvas'
// f2-canvas.js
...
export default global['__wxComponents']['f2-canvas/f2-canvas']
</script>
